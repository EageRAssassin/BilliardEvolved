...
let cue_ball = {
  ...
  size = (30.,30.);
  velocity = (0.,0.);
  position = (780.,280.); (*see arrangement.png for init. for now all are
                            the same place *)
...
let one_ball = {
  ...
  size = (30.,30.);
  velocity = (0.,0.);
  position = (312.,280.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
...
let two_ball = {
  ...
  size = (30.,30.);
  velocity = (0.,0.);
  position = (208.,310.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let three_ball = {
  ...
  size = (30.,30.);
  velocity = (0.,0.);
  position = (286.,265.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let four_ball = {
  ...
  size = (30.,30.);
  velocity = (0.,0.);
  position = (234.,265.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let five_ball = {
  ...
  size = (30.,30.);
  velocity = (0.,0.);
  position = (208.,250.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let six_ball = {
  ...
  size = (30.,30.);
  velocity = (0.,0.);
  position = (260.,310.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let seven_ball = {
  ...
  size = (30.,30.);
  velocity = (0.,0.);
  position = (208.,340.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let eight_ball = {
  ...
  size = (30.,30.);
  velocity = (0.,0.);
  position = (260.,280.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let nine_ball = {
  ...
  size = (30.,30.);
  velocity = (0.,0.);
  position = (234.,235.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let ten_ball = {
  ...
  size = (30.,30.);
  velocity = (0.,0.);
  position = (208.,280.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let eleven_ball = {
  ...
  size = (30.,30.);
  velocity = (0.,0.);
  position = (286.,295.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let twelve_ball = {
  ...
  size = (30.,30.);
  velocity = (0.,0.);
  position = (208.,220.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let thirteen_ball = {
  ...
  size = (30.,30.);
  velocity = (0.,0.);
  position = (234.,325.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let fourteen_ball = {
  ...
  size = (30.,30.);
  velocity = (0.,0.);
  position = (260.,250.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let fifteen_ball = {
  ...
  size = (30.,30.);
  velocity = (0.,0.);
  position = (234.,295.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
