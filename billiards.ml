...
let cue_ball = {
  ...
  size = (30.,30.);
  velocity = (30.,30.);
  position = (780.,275.); (*see arrangement.png for init. for now all are
                            the same place *)
...
let one_ball = {
  ...
  size = (30.,30.);
  velocity = (30.,30.);
  position = (312.,275.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
...
let two_ball = {
  ...
  size = (30.,30.);
  velocity = (30.,30.);
  position = (208.,305.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let three_ball = {
  ...
  size = (30.,30.);
  velocity = (30.,30.);
  position = (286.,260.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let four_ball = {
  ...
  size = (30.,30.);
  velocity = (30.,30.);
  position = (234.,260.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let five_ball = {
  ...
  size = (30.,30.);
  velocity = (30.,30.);
  position = (208.,245.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let six_ball = {
  ...
  size = (30.,30.);
  velocity = (30.,30.);
  position = (260.,305.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let seven_ball = {
  ...
  size = (30.,30.);
  velocity = (30.,30.);
  position = (208.,335.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let eight_ball = {
  ...
  size = (30.,30.);
  velocity = (30.,30.);
  position = (260.,275.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let nine_ball = {
  ...
  size = (30.,30.);
  velocity = (30.,30.);
  position = (234.,230.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let ten_ball = {
  ...
  size = (30.,30.);
  velocity = (30.,30.);
  position = (208.,275.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let eleven_ball = {
  ...
  size = (30.,30.);
  velocity = (30.,30.);
  position = (286.,290.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let twelve_ball = {
  ...
  size = (30.,30.);
  velocity = (30.,30.);
  position = (208.,215.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let thirteen_ball = {
  ...
  size = (30.,30.);
  velocity = (30.,30.);
  position = (234.,320.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let fourteen_ball = {
  ...
  size = (30.,30.);
  velocity = (30.,30.);
  position = (260.,245.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
...
let fifteen_ball = {
  ...
  size = (30.,30.);
  velocity = (30.,30.);
  position = (234.,290.); (*see arrangement.png for init. for now all are
                            the same place *)
  score = 100;
  (* legal_player = None; (* whoever pots a solid first *)
     legal_pot = None; *)
